<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Auth.Master" AutoEventWireup="true" CodeBehind="VerifyEmail.aspx.cs" Inherits="JobConnect.Pages.Auth.VerifyEmail" %>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <asp:TextBox ID="txtVerificationCode" runat="server" 
                                ...
                                MaxLength="6" placeholder="123456"></asp:TextBox>
                        </div>
