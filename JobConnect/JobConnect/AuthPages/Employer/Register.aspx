<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Auth.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="JobConnect.AuthPages.Employer.Register" %>
        ...
        <div class="login-card bg-white md:rounded-xl shadow-md overflow-hidden border border-gray-100 w-full max-w-md">
            ...
            <div class="card-content p-6 sm:p-8">
                <div class="text-center mb-6">
                    <h1 class="mt-4 text-2xl font-bold text-gray-900">Create employer account</h1>
                </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <asp:TextBox ID="txtCompanyName" runat="server" 
                                    ...
                                    placeholder="Your Company" autocomplete="organization" MaxLength="100"></asp:TextBox>
                            </div>
